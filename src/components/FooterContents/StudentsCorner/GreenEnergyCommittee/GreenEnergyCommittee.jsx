...
const committeeData = [
  {
    ...
    members: ['Dr.V.Sangeetha (Chemical)', 'Dr.A.R.Krishnaraja (Civil)', 'Mr.A.Mohan Kumar (Mechanical)']
  },
  {
  ...
  {
    policy: 'Divyangan Friendliness',
    members: ['Dr.R.Rajasekar (Mechanical)']
  },
  {
    policy: 'Information Policy',
    members: ['Dr.P.Ravichandran (Mechatronics)']
  },
  {
    policy: 'Information Technology Policy Committee',
    members: ['Dr.R.Thangarajan (CSD)', 'Dr.R.R.Rajalaxmi (CSE)']
  },
  {
  ...
  return (
    <>
      ...
      <div className="green-container">
        <h2>Institution Policy Document & Green, Energy and Environment Audit Committee</h2>
