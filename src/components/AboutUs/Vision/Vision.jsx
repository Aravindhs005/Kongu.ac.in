    ...
    <>
      ...
      <div className="vision-container">
        ...
        <div className="vision-row">
          <img src={mission} alt="Vision & Mission" className="aboutkec-image" />
        ...
        <div className="vision-row">
          <div className="vision-section animate-zoom">
            ...
            <ul>
              <li>Provide value-based quality education for developing the students as competent and responsible citizens.</li>
              <li>Contribute to the nation and beyond through the state of the art Technology.</li>
              <li>Continuously improve our services.</li>
            </ul>
          </div>
          <img src={qualitypolicy} alt="Quality Policy" className="aboutkec-image" />
