...
const PlacementSection = () => {
  ...
  const importAllPdfs = (r) =>
    ...
    const trainingDetailsFiles = importAllPdfs(
        require.context("../../../assets/docs/Placement/Training Details", false, /\.pdf$/)
    );
    
    const trainingSchedulesFiles = importAllPdfs(
        require.context("../../../assets/docs/Placement/Training Schedules", false, /\.pdf$/)
    );
    ...
    <div className="placement-section-container">
      ...
      {activeTab === "Home" && (
        <div className="placement-home">
          ...
          <ul>
            <li><strong>Career Guidance:</strong> Guidance and counselling to identify career goals, suitable courses, and relevant skills.</li>
            <li><strong>Industry Connections:</strong> Collaborations with companies for internships, campus drives, and partnerships.</li>
            <li><strong>Job Postings:</strong> Disseminates job openings and internships, reducing stress during job hunting.</li>
          </ul>
      ...
      <div className="placement-training">
        <div className="training-tab-content fade-in">
            <h2>Training Cell</h2>
            <p>
                The Training Cell plays a vital role in students’ success and is one of the cornerstones of the Institute.
                This cell is committed to enhancing the professional skills of the students to meet industrial needs. 
                It organizes more than 350 hours of training, which includes:
            </p>
            ...
            <div className="training-modules">
                ...
                <li>Mock Interview & Placement Readiness Sessions (via Industry Experts)</li>
      ...
      {activeTab === "Contact" && <div className="placement-contact">
    ...
    <div className="placement-contact-wrapper">
      ...
      <div className="placement-contact-card">
        ...
        <p>
          <strong>Mr. P. Dhakshinamoorthy</strong><br />
          Placement Officer<br />
          Mobile: <a href="tel:9790004095">9790004095</a><br />
          Phone: <a href="tel:04294226644">04294 – 226644</a>
        </p>
        <p>
          <strong>Mr. S. Kavin</strong><br />
          Deputy Placement Officer<br />
          Mobile: <a href="tel:9600777618">9600777618</a>
        </p>
        <p>
          <strong>Mr. P. Sukumar</strong><br />
          Assistant Placement Officer<br />
          Mobile: <a href="tel:9629455327">9629455327</a>
        </p>
        <p>
          <strong>Mr. P. Dineshkumar</strong><br />
          Assistant Placement Officer<br />
        ...
        <p>
          ...
          Tamil Nadu, India.<br />
          Ph: <a href="tel:04294226564">04294 - 226 564</a><br />
          Fax: 04294 – 220087<br />
          Email: <br /> <a href="mailto:placement@kongu.edu">placement@kongu.edu</a><br /> <a href="mailto:placement@kongu.ac.in">placement@kongu.ac.in</a>
        </p>
      </div>
      ...
      <div className="placement-contact-card">
        <h3>Training Cell</h3>
        <p>
          <strong>Dr. N. Shanthi</strong><br />
          Training Officer<br />
          Mobile: <a href="tel:9842013355">9842013355</a><br />
          Phone: <a href="tel:04294226262">04294 – 226262</a>
        </p>
        <p>
          <strong>Mr. D. Vijay Anand</strong><br />
          Assistant Training Officer<br />
          Mobile: <a href="tel:9942013143">9942013143</a>
        </p>
        <p>
          <strong>Mr. B. Bizu</strong><br />
          Assistant Training Officer<br />
        ...
        <p>
          ...
          Perundurai, Erode – 638 060,<br />
          Tamil Nadu, India.<br />
          Ph: <a href="tel:04294226262">04294 - 226 262</a><br />
          Fax: 04294 – 220087<br />
          Email: <br /><a href="mailto:training@kongu.edu">training@kongu.edu</a> <br /> <a href="mailto:training@kongu.ac.in">training@kongu.ac.in</a>
        </p>
      </div>
