    ...
    <>
      ...
      <div className="library-wrapper">
        ...
        {activeSection === "Home" && (
          <section className="library-section">
            ...
            <table className="library-table">
                ...
                <tbody>
                {[
                    ["Civil Engineering", 1937, 6200],
                    ["Mechanical Engineering", 1965, 6215],
                    ["Automobile Engineering", 805, 2553],
                    ["Mechatronics Engineering", 1463, 4605],
                    ["Chemical Engineering", 1522, 4773],
                    ["Food Technology", 1262, 3907],
                    ["Electronics and Communication Engineering", 2079, 6341],
                    ["Electrical and Electronics Engineering", 1717, 5325],
                    ["Electronics and Instrumentation Engineering", 1451, 4685],
                    ["Computer Science and Engineering", 1997, 5678],
                    ["Information Technology", 1475, 4620],
                    ["Artificial Intelligence and Machine Learning", 376, 1441],
                    ["Artificial Intelligence and Data Science", 381, 1418],
                    ["Computer Science and Design", 386, 1043],
                    ["B.Sc", 1989, 6181],
                    ["M.Sc", 204, 589],
                    ["Science and Humanities", 3007, 8869],
                    ["Master of Computer Applications", 3042, 9205],
                    ["Master of Business Administration", 3472, 9512],
                    ["PG Courses in Engineering", 850, 1779],
                    ["Total", 31380, 94939]
                ].map((row, i) => (
                    <tr key={i}>
                    <td>{i + 1 <= 20 ? i + 1 : ""}</td>
            ...
            <ul className="library-bullet-list">
            <li>Value of Books: Rs. 4.63 Crore</li>
            ...
            <li>No. of Book Bank Books: 3,062</li>
            <li>No. of Online Journals Subscription: 10,563</li>
            <li>Other Digital Resources: 7,850 <br /> (Including Book CDs/Audio/Video)</li>
            <li>Ph.D Thesis: 469</li>
            </ul>
        ...
        <div className="library-section-content">
            ...
            <p>
            There are 3062 books in the Book Bank section. The books can be provided exclusively for Post Matric Scholarship holders of the SC & ST students. Each student can take up to 10 books, which can be kept for one semester.
            </p>
        ...
        <div className="library-section-content">
            ...
            <p><strong>1. Turnitin Feedback Studio:</strong> <a href="https://access.auerc.com/keca" target="_blank" rel="noopener noreferrer">access.auerc.com/keca</a></p>

            <h2>SELF SUBSCRIPTION</h2>
            <p><strong>1. EBSCO Business Source Elite:</strong> <a href="https://research.ebsco.com/c/ndiofi/search" target="_blank" rel="noopener noreferrer">research.ebsco.com</a></p>
            <p><strong>2. DELNET Discovery Portal:</strong> <a href="https://discovery1.delnet.in/" target="_blank" rel="noopener noreferrer">discovery1.delnet.in</a></p>
        </div>
        )}
        ...
        <div className="library-section-content">
            ...
            <li><strong>Faculty/Staff:</strong> Up to 6 items for 1 month</li>
        ...
        <div className="library-section-content">
            ...
            <table className="staff-table">
                ...
                {[
                    ...
                    ["4", "Mr. P.M. GNANASEKARAN", "MA., C.Lib.I.Sc.", "LIB. ASST. (Sl.G)"],
                    ["5", "Mr. R. THANGARAJ", "B.Com., M.Lib.I.Sc.", "LIB. ASST. (Sr.G)"],
                    ["6", "Mr. C. SWAMINATHAN", "B.Com., M.Lib.I.Sc., DPCS.", "LIB. ASST. (Sr.G)"],
                    ["7", "Mr. S. SURESH", "C.Lib.I.Sc.", "LIBRARY ASSISTANT"],
                    ["8", "Mr. S. SHANMUGAM", "C.Lib.I.Sc.", "LIBRARY ASSISTANT"],
                    ["9", "Ms. N. GOMATHIPRIYA", "M.Sc., B.Lib.I.Sc.", "LIBRARY ASSISTANT"],
                    ["10", "Mr. K. DURAISWAMI", "T/W BOTH HIGHER/SHORT HAND (English Jr.)", "DATA ENTRY OPERATOR"],
                    ["11", "Ms. R. EASWARI", "B.Sc.", "TECHNICAL ASSISTANT"],
                    ["12", "Mr. V. NANDHAKUMAR", "B.Com (CS)", "TECHNICAL ASSISTANT"],
                    ["13", "Ms. M. SATHYA", "B.A", "LIBRARY ASSISTANT"],
                    ["14", "Mr. J. KARTHIK", "BBA", "TECHNICAL ASSISTANT"]
